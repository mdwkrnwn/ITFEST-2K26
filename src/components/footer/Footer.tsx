  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-accent-light/5 rounded-full blur-[150px] translate-x-1/4 translate-y-1/4" />
        <div className="absolute top-1/2 left-0 w-[400px] h-[400px] bg-accent-light/3 rounded-full blur-[120px] -translate-x-1/2" />
        <div
      ...
      >
        <motion.div
          ...
          className="h-[1px] bg-gradient-to-r from-transparent via-accent-light/40 to-transparent absolute top-0 w-full"
        />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 sm:gap-12 lg:gap-16 mb-12 sm:mb-16">
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 p-1.5 bg-white/[0.03] border border-white/10 rounded-2xl focus-within:border-accent-light/50 focus-within:bg-white/[0.05] transition-all duration-300 backdrop-blur-md">
                  <RiMailLine className="text-white/30 size-5 ml-3 shrink-0 group-focus-within:text-accent-light transition-colors" />
                  <input
                    type="email"
                    value={email}
            ...
            {Object.entries(footerLinks).map(([category, links], catIdx) => (
              ...
              >
                <h4 className="text-[11px] font-black text-accent-light uppercase tracking-[0.2em] mb-6">
                  {category}
                </h4>
                <ul className="space-y-3">
                  {links.map((link) => (
                    <li key={link.label}>
                      ...
                      >
                        {link.label}
                        <span className="absolute -bottom-1 left-0 w-0 h-px bg-accent-light group-hover:w-full transition-all duration-300 ease-out" />
                      </a>
                    </li>
                  ))}
                </ul>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 pb-4 border-t border-white/5">
            <div className="flex items-center gap-3">
              {socials.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-12 h-12 rounded-full bg-white/[0.03] border border-white/10 flex items-center justify-center text-white/50 hover:bg-accent-light hover:text-white hover:border-accent-light transition-all duration-300 shadow-sm"
                  title={social.label}
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
              <a
                ...
                className="flex items-center gap-2 text-white/40 hover:text-accent-light transition-colors text-xs sm:text-sm font-medium"
              >
                <RiMailLine size={16} />
            ...
            <motion.button
              ...
              className="hidden md:flex w-12 h-12 rounded-full bg-accent-light/10 border border-accent-light/20 items-center justify-center text-accent-light hover:bg-accent-light hover:text-white transition-all duration-300 shadow-lg"
            >
          ...
          <div className="w-full max-w-7xl mx-auto px-4 flex justify-center items-center translate-y-[8%]">
            ...
            >
              ...
              <text
                ...
                y="75%"
                textAnchor="middle"
                className="text-[170px] font-black uppercase tracking-tighter fill-accent-light"
        ...
        <div className="w-full relative z-30 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mt-6 mb-8">
          <div className="relative w-full h-[2px] bg-white/10 rounded-full">
            <motion.div
              ...
              className="absolute inset-0 bg-gradient-to-r from-[#065ce1] to-[#4F8CFF] rounded-full shadow-[0_0_15px_rgba(6,92,225,0.45)]"
            />

            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-4 h-4 bg-accent-light rounded-full border-[3px] border-[#1a1a1a] shadow-[0_0_10px_rgba(242,143,59,0.8)] z-40 flex items-center justify-center">
              <div className="w-1.5 h-1.5 bg-white rounded-full animate-pulse" />
            </div>

            <div className="absolute left-0 -top-6 text-[10px] font-black uppercase tracking-[0.2em] text-accent-light">
              1000+ UMKM Connected
            </div>
