...
const faqs = [
  {
    question: "Apa itu UFinder?",
    answer:
      "UFinder adalah platform digital yang membantu masyarakat menemukan UMKM di sekitar mereka dengan lebih mudah. Mulai dari kuliner, fashion, jasa, kerajinan, hingga bisnis lokal lainnya dalam satu tempat.",
  },
  {
    question: "Apakah UMKM bisa bergabung di UFinder?",
    answer:
      "Tentu. Pemilik UMKM dapat mendaftarkan usahanya secara gratis untuk meningkatkan visibilitas bisnis, menjangkau pelanggan baru, dan memperluas pasar melalui platform UFinder.",
  },
  {
    question: "Bagaimana cara menemukan UMKM terdekat?",
    answer:
      "Pengguna dapat menggunakan fitur pencarian dan lokasi untuk menemukan UMKM berdasarkan kategori, nama usaha, maupun jarak terdekat dari posisi pengguna.",
  },
  {
    question: "Apakah UFinder hanya untuk UMKM kuliner?",
    answer:
      "Tidak. UFinder mendukung berbagai jenis UMKM seperti kuliner, fashion, jasa, kerajinan, kecantikan, pertanian, hingga bisnis kreatif lainnya.",
  },
  {
    question: "Apa manfaat UFinder bagi UMKM?",
    answer:
      "UFinder membantu UMKM meningkatkan eksposur digital, mempermudah pelanggan menemukan usaha mereka, serta menyediakan informasi bisnis yang lebih terstruktur dan mudah diakses.",
  },
  {
    question: "Apakah UFinder tersedia di seluruh Indonesia?",
    answer:
      "UFinder dirancang untuk mendukung UMKM di seluruh Indonesia. Cakupan data akan terus berkembang seiring bertambahnya UMKM yang bergabung ke dalam platform.",
  },
];
...
export default function FAQ() {
  ...
  return (
    <section
      id="faq-section"
      className="relative w-full min-h-screen py-24 lg:py-32 bg-[#F4F3EE] overflow-hidden font-[family:var(--font-jakarta)] select-none"
    >
      <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-5">
            <div className="sticky top-24 lg:top-32">
              ...
              >
                Temukan jawaban atas pertanyaan seputar UFinder, cara menemukan
                UMKM, dan manfaat platform bagi pelaku usaha maupun pelanggan.
              </motion.p>
              ...
              >
                ...
                <MessageCircle
                  className="mb-4 sm:mb-6 text-accent-light"
                  size={32}
                />
                <h4 className="text-lg sm:text-xl font-black uppercase tracking-tight mb-2">
                  Butuh Bantuan?
                </h4>
                <p className="text-white/60 text-xs sm:text-sm mb-6 font-medium">
                  Tim UFinder siap membantu UMKM maupun pengguna yang memiliki
                  pertanyaan terkait platform.
                </p>
          ...
          <div className="lg:col-span-7 space-y-3.5 sm:space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span
                    className={`font-black text-sm sm:text-base md:text-xl uppercase tracking-tighter transition-colors duration-500 max-w-[85%] ${
                      openIndex === index ? "text-accent" : "text-[#2D2A26]"
                    }`}
                  >
                    {faq.question}
                  </span>
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center transition-all duration-500 shrink-0 ${
                      openIndex === index
                        ? "bg-accent text-white rotate-180 shadow-md"
                        : "bg-[#2D2A26]/5 text-[#2D2A26]"
                    }`}
                  >
